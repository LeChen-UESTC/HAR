...
# find_pruneable_heads_and_indices is no longer exported from modeling_utils.
...
class BertPreTrainedModel(PreTrainedModel, ModuleUtilsMixin):
    """
    ...
    # Compatibility with transformers >= 5 where PreTrainedModel expects this
    # attribute during weight tying.
